trigger ASI_MFM_Item_Group_BeforeUpdate on ASI_MFM_Item_Group__c (Before Update) {
    ...
    if(CN_Item_Group.size() > 0){
        ASI_MFM_CN_ItemGroup_TriggerClass.beforeUpdateFunction(CN_Item_Group, trigger.oldMap);
    }
