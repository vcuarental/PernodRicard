/*********************************************************************************
 * Name: ASI_Luxury_CampaignMember_AfterUpdate
 * Description: CampaignMember LUX Trigger after update: Redirection based on record types
 *
 * Version History
...
*********************************************************************************/
trigger ASI_Luxury_CampaignMember_AfterUpdate on CampaignMember (after update) {
