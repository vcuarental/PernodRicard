/*********************************************************************************
 * Name: ASI_CRM_VN_Contract_Expenditure_BeforeInser
 * Description: Before insert trigger for contract expenditure
 *
 * Version History
...
*/
trigger ASI_CRM_VN_Contract_Expenditure_BeforeInser on ASI_CRM_VN_Contract_Expenditure__c (before insert) {
