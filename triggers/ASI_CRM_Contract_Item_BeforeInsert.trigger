/*********************************************************************************
 * Name:ASI_CRM_Contract_Item_BeforeInsert
 * Description: Before Insert Contract Item Trigger for CRM JP
 *
 * Version History
...
*********************************************************************************/
trigger ASI_CRM_Contract_Item_BeforeInsert on ASI_CRM_Purchase_Contract_Line_Item__c (before insert) {     
