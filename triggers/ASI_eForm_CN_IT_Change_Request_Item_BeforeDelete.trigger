trigger ASI_eForm_CN_IT_Change_Request_Item_BeforeDelete on ASI_eForm_IT_Change_Request_Item__c (before delete) {
    ...
    Map<Id,ASI_eForm_IT_Change_Request__c> headerMap = 
     new Map<Id,ASI_eForm_IT_Change_Request__c>([Select Id, ASI_eForm_Status__c 
      ...
      like '%ASI_eForm_CN_IT_Change_Request%' and id in :headerIds]);
