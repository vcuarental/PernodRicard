trigger ASI_NPP_New_Product_Promotion_BeforeUpdate on ASI_NPP_New_Product_Promotion__c (before update) {
    ...
    if(trigger.new[0].RecordTypeId == SGrectypeid )
    {
        ...
        ASI_NPP_NewProductPromotion_TriggerClass.setSubBrandBudgetVolume(trigger.new, trigger.oldMap);
