/*********************************************************************************
 * Name:ASI_TnE_ClaimDetail_AfterUpdate
 * Description: After Update Trigger for TnE Claim Detail
 *
 * Version History
...
*********************************************************************************/
trigger ASI_TnE_ClaimDetail_AfterUpdate on ASI_TnE_ClaimDetail__c (after update) {
