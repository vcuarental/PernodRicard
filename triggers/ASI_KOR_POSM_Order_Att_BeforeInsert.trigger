/***************************************************************************************************************************
* Name:        ASI_KOR_POSM_Order_Att_BeforeInsert
* Description: Before Insert Trigger for ASI_KOR_POSM_Order_Attachment
*
* Version History
...
****************************************************************************************************************************/
trigger ASI_KOR_POSM_Order_Att_BeforeInsert on ASI_KOR_POSM_Order_Attachment__c (before insert) {
