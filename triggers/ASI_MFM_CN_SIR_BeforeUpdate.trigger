trigger ASI_MFM_CN_SIR_BeforeUpdate on ASI_MFM_Stock_In_Request__c (Before Update) {
    ...
    if(CN_SIR_List.size() > 0){
        ...
        ASI_MFM_CN_Stock_In_Request_TriggerClass.beforeUpdateFunction(CN_SIR_List, trigger.oldMap);
    }
}