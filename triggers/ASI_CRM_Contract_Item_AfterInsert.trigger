/*********************************************************************************
 * Name:ASI_CRM_Contract_Item_AfterInsert
 * Description: After Insert Contract Item Trigger for CRM JP
 *
 * Version History
...
*********************************************************************************/
trigger ASI_CRM_Contract_Item_AfterInsert on ASI_CRM_Purchase_Contract_Line_Item__c (after insert) {     
