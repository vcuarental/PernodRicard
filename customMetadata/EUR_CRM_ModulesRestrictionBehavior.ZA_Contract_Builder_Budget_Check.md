...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>ZA Contract Builder Budget Check</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">ContractStatusUpdate</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">EUR_CRM_Status__c,EUR_CRM_Budget_Difference__c</value>
    </values>
    <values>
        <field>EUR_CRM_Field_Value__c</field>
        <value xsi:type="xsd:string">Draft,0</value>
    </values>
    <values>
        <field>EUR_CRM_Message__c</field>
        <value xsi:type="xsd:string">You can not sent the contract for approve, because the budget current balance is less then deductible amount.</value>
    </values>
    <values>
