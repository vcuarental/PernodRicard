...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Visit Frequency Calendar RU Standard</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Частота посещения</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">не посещается,1 раз в 2 месяца,1 раз в неделю,2 раза в неделю,3 раза в неделю,1 раз в квартал,1 раз в месяц,2 раза в месяц,3 раза в месяц</value>
    </values>
    <values>
        <field>EUR_CRM_ProfileID__c</field>
        <value xsi:type="xsd:string">00eD0000001AvAfIAK</value>
    </values>
    <values>
