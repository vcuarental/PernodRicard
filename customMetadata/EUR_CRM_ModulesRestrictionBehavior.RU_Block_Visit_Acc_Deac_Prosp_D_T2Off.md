...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>RU Block Visit : Acc Deac Prosp D T2Off</label>
    <protected>false</protected>
    <values>
        <field>EUR_CRM_AccountFieldValues__c</field>
        <value xsi:type="xsd:string">EUR_RU_Direct_Type_2_Off_Trade,Active,Prospect (Deactivation)</value>
    </values>
    <values>
        <field>EUR_CRM_AccountFields__c</field>
        <value xsi:type="xsd:string">RecordTypeId.DeveloperName,EUR_CRM_Status__c,EUR_CRM_Status_Requested__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">This visit can&apos;t be created because the requested status &quot;Prospect (Deactivation)&quot; was not approved</value>
    </values>
    <values>
