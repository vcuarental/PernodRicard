...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>ASI_eForm_KR/ASI_eForm_KR_RR_Approved</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>ASI_eForm_KR/ASI_eForm_KR_RR_Rejected</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        <fullName>ASI_eForm_Approved_Status</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>Approved</literalValue>
    ...
    <fieldUpdates>
        <fullName>ASI_eForm_Draft1</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>Draft</literalValue>
        <name>Drafted Status</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>ASI_eForm_Submitted2</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>Submitted</literalValue>
        <name>Submitted</name>
        <notifyAssignee>false</notifyAssignee>
    ...
    <fieldUpdates>
        <fullName>Update_in_process</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>In Progress</literalValue>
        <name>Update_in_process</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Literal</operation>
        <protected>false</protected>
        <reevaluateOnChange>false</reevaluateOnChange>
    ...
    <fieldUpdates>
        <fullName>Update_in_process1</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>Submitted</literalValue>
        <name>Update_in_process</name>
        <notifyAssignee>false</notifyAssignee>
