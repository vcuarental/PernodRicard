...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>ASI_CRM_AccountMovement__c.RecordTypeId</field>
            <operation>equals</operation>
            <value>TW Account Movement</value>
        </criteriaItems>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>ASI CRM TW Copy Account Region</fullName>
        <actions>
            <name>ASI_CRM_TW_Copy_Account_Region</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
