...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>ASI_eForm_KR/ASI_eForm_KR_Tuition_Approved</template>
    </alerts>
    <alerts>
        <fullName>ASI_eForm_Approved_1</fullName>
        <description>Approved Email Alert</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>ASI_eForm_KR/ASI_eForm_KR_Tuition_Rejected</template>
    </alerts>
    <alerts>
        <fullName>ASI_eForm_Rejected_1</fullName>
        <description>Rejected Email Alert</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
