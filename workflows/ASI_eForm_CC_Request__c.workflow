...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>ASI_eForm_KR/ASI_eForm_KR_CC_Request_Approved</template>
    </alerts>
    <alerts>
        <fullName>ASI_eForm_Approved_Email_Alert</fullName>
        <description>Approved Email Alert</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>ASI_eForm_KR/ASI_eForm_KR_CC_Request_Rejected</template>
    </alerts>
    <alerts>
        <fullName>ASI_eForm_Rejected_Email_Alert</fullName>
        <description>Rejected Email Alert</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
    ...
    <fieldUpdates>
        <fullName>ASI_eForm_Rejected_Status</fullName>
        <field>ASI_eForm_Status__c</field>
        <literalValue>Rejected</literalValue>
