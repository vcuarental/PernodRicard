...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>ASI_CRM_T2_Selling_Price__c.RecordTypeId</field>
            <operation>equals</operation>
            <value>ASI_CRM_CN_T2_Selling_Price</value>
        </criteriaItems>
        <criteriaItems>
            <field>ASI_CRM_T2_Selling_Price__c.ASI_CRM_CN_WS_Tier__c</field>
    ...
    <rules>
        <fullName>ASI_CRM_CN_T2_Selling_Price_Update_WS_Tier</fullName>
        <actions>
