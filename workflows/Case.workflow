...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>LAT_Templates/CSE_CaseClosedAccountRecordUpdate_AR</template>
    </alerts>
    <alerts>
        ...
        <protected>false</protected>
        <senderType>CurrentUser</senderType>
        <template>LAT_Templates/CSE_CaseClosedViaLegalApproved_AR</template>
    </alerts>
    <alerts>
        ...
        <protected>false</protected>
        <senderType>CurrentUser</senderType>
        <template>LAT_Templates/CSE_CaseClosedViaLegalRejected_AR</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>LAT_Templates/CSE_CasePaymentProposalApproved_AR</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>LAT_Templates/CSE_CasePaymentProposalRejected_AR</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Nao_aprovacao_da_PRB_quanto_a_renovacao_de_contrato</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Entrega_de_carta_de_nao_renovacao_de_contrato</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Demanda_Proposta_de_pagamento_aprovada</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/LAT_BR_CaseRejected</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Visualforce_Email_Templates/Prorroga_o_de_Contrato_Reprovada</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>unfiled$public/LAT_MX_CSE_CloseCaseAccountAlteration</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Nao_renovacao_de_contrato_aprovada</template>
    </alerts>
    <alerts>
    ...
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Demanda_Proposta_de_pagamento_rejeitada</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/Nao_aprovacao_do_cliente_quanto_a_renovacao_de_contrato</template>
    </alerts>
    <alerts>
        ...
        <senderType>CurrentUser</senderType>
        <template>Modelos_Pernod/SLA_de_termino_de_contrato</template>
    </alerts>
    <alerts>
    ...
    <fieldUpdates>
        ...
        <field>Subject</field>
        <formula>text(Type) + &quot; - &quot; + text(Reason)</formula>
    ...
    <fieldUpdates>
        ...
        <formula>PRIORVALUE( Description ) &amp; BR() &amp; BR() &amp; &quot;Solicitar ao cliente aprovação da renovação&quot;</formula>
    ...
    <fieldUpdates>
        ...
        <field>Description</field>
        <formula>PRIORVALUE( Description ) &amp; BR() &amp; BR() &amp; &quot;Emitir carta de Não Renovação de Contrato&quot;</formula>
    ...
    <fieldUpdates>
        ...
        <field>Description</field>
        <formula>PRIORVALUE( Description ) &amp; BR() &amp; BR() &amp; &quot;Negociar prorrogação de contrato com o cliente&quot;</formula>
    ...
    <fieldUpdates>
        ...
        <field>Value_due__c</field>
        <formula>Account.Amount_due__c</formula>
    ...
    <fieldUpdates>
        ...
        <field>Financial_Approval__c</field>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_regional_filed__c</field>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_Dis_Director__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_Dis_Manager__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_terms__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_Dis_Coordinator__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_Dis_Sig_Customer__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Checked_over_by_Dis_Del_Customer__c</field>
        <formula>$User.FirstName &amp; &quot; &quot; &amp; $User.LastName &amp; &quot; em &quot; &amp; MID(text((NOW()-3/24)), 9,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 6,2) &amp; &quot;/&quot; &amp; MID(text((NOW()-3/24)), 1,4) &amp; MID(text((NOW()-3/24)), 11,6)</formula>
    ...
    <fieldUpdates>
        ...
        <field>Termination_approved__c</field>
        <literalValue>1</literalValue>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND(ISPICKVAL( Type, &quot;Não Renovação de Contrato&quot;), ISPICKVAL(  Reason , &quot;Carta de não renovação de contrato&quot;), ISPICKVAL( Status, &quot;Fechado e resolvido&quot;))</formula>
    ...
    <rules>
        ...
        <formula>AND( PRIORVALUE( DA_Number__c ) &lt;&gt; DA_Number__c , $RecordType.DeveloperName = &quot;Gerar_D_A_no_sistema_ME&quot; )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>(  $RecordType.DeveloperName=&apos;CSE_1_AccountAlteration_ARG&apos; ||  $RecordType.DeveloperName=&apos;CSE_2_AccountAlteration_URU&apos;  )  &amp;&amp;  ( ISNEW() || ISCHANGED(AccountId) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>(  $RecordType.DeveloperName=&apos;CSE_1_AccountAlteration_ARG&apos; ||  $RecordType.DeveloperName=&apos;CSE_2_AccountAlteration_URU&apos;  )  &amp;&amp;  ( ISPICKVAL(Status, &apos;Fechado e cancelado&apos;) || ISPICKVAL(Status, &apos;Fechado e resolvido&apos;) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <description>Updates the record type to &apos;Propuesta de Pagos_AR&apos; when Type equals ‘Propuesta de Pago’.</description>
        <formula>$RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_AR&apos; &amp;&amp; ISPICKVAL(Type, &apos;Proposta de pagamento&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>$RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_UY&apos;  &amp;&amp;  ISPICKVAL(Type, &apos;Proposta de pagamento&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>$RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_AR&apos;  &amp;&amp;  ISPICKVAL(Type, &apos;Overdue to attorneys&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <formula>$RecordType.DeveloperName=&apos;CSE_WOPaymentProposal_UY&apos;  &amp;&amp;  ISPICKVAL(Type, &apos;Overdue to attorneys&apos;)</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Cancellation_Defined__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <formula>AND ( $RecordType.Name = &quot;Alteração de cadastro de clientes&quot;, NOT(PRIORVALUE(IsClosed)), NOT(ISPICKVAL( Reason, &quot;Alt. transportadora&quot;)), NOT(ISPICKVAL( Reason, &quot;Alt. recebimento carga&quot;)), NOT(ISPICKVAL( Reason, &quot;Alt. tipo de frete&quot;)), NOT(ISPICKVAL( Reason, &quot;Alt. tipo de veículo&quot;)), NOT(ISPICKVAL( Reason, &quot;Alt. agendamento&quot;)), NOT(ISPICKVAL( Reason, &quot;Alt. paletização especial&quot;)), IsClosed, OR ( ISPICKVAL(Priorvalue( Status), &quot;Em análise - Crédito e cobrança&quot;), ISPICKVAL(Priorvalue( Status), &quot;Em análise - Planejamento Comercial&quot;), ISPICKVAL(Priorvalue( Status), &quot;Em análise - Customer Service&quot;) ), NOT(ISPICKVAL(Status, &quot;Reprovado&quot;)) )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_filed_by_regional__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_signed_by_the_board__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_signed_by_the_customer__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_signed_by_the_coordinator__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_signed_by_the_manager__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Case.Termination_delivered_p_subscribe_client__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    ...
    <rules>
        ...
        <formula>($RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationStatistical&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationCreditAndCollections&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationLegal&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationLogistics&apos;) &amp;&amp; ( ISPICKVAL(Status, &apos;Fechado e cancelado&apos;) || ISPICKVAL(Status, &apos;Fechado e resolvido&apos;) )</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <formula>($RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationStatistical&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationCreditAndCollections&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationLegal&apos; || $RecordType.DeveloperName=&apos;LAT_MX_CSE_AccountAlterationLogistics&apos;) &amp;&amp; ISPICKVAL(Status, &apos;Fechado e resolvido&apos;)</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Case.Reason_for_not_approved__c</field>
