...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        ...
        <template>Modelos_Pernod/Pedido_com_erro_no_envio_ao_JDE</template>
    </alerts>
    <fieldUpdates>
    ...
    <fieldUpdates>
        ...
        <field>Cancelamento_aprovado__c</field>
    ...
    <fieldUpdates>
        ...
        <field>DT_delivery__c</field>
        <formula>Data_Entrega_Calculada__c</formula>
    ...
    <fieldUpdates>
        ...
        <formula>Account.Payment_Condition__r.Name</formula>
...
Account.Payment_Condition__r.Name,
LAT_MX_ClientPaymentPeriod__c))</formula>
    ...
    <fieldUpdates>
        ...
        <field>Name</field>
        <formula>Codigo_do_cliente_AN8__c + &apos;-&apos; + LAT_MX_OrderNumberCRM__c</formula>
    ...
    <fieldUpdates>
        ...
        <formula>TEXT(Pais__c)+&apos;-&apos;+LEFT(TEXT(Type), 2)+&apos;-&apos;+NR_order_JDE__c+&apos;-&apos;+LAT_CompanyCode__c</formula>
    ...
    <fieldUpdates>
        ...
        <field>Campo_de_formatacao__c</field>
    ...
    <fieldUpdates>
        ...
        <field>Integracao_Retorno_JDE__c</field>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>(RecordType.DeveloperName=&apos;Nova_oportunidade&apos;  ||RecordType.DeveloperName=&apos;Bloqueia_alteracao_do_cabecalho&apos;  ||RecordType.DeveloperName=&apos;Bloqueia_alteracao&apos;) &amp;&amp;   ISPICKVAL(Account.Freight_Type__c, &quot;FOB&quot;)</formula>
    ...
    <rules>
        ...
        <criteriaItems>
            <field>Opportunity.Integracao__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <criteriaItems>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Opportunity.DT_delivery__c</field>
            <operation>equals</operation>
        </criteriaItems>
        <criteriaItems>
            <field>Opportunity.Data_Entrega_Calculada__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <criteriaItems>
            <field>Opportunity.RecordTypeId</field>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>(ISBLANK(LAT_JDEOrderKey__c) || ISCHANGED(Type) ) &amp;&amp; NOT(ISBLANK(Pais__c)) &amp;&amp; NOT(ISPICKVAL(Type,&apos;&apos;)) &amp;&amp; NOT(ISBLANK(NR_order_JDE__c))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
    ...
    <rules>
        <fullName>OPP_WF03_RetainedOrder_AR</fullName>
        <actions>
            <name>OPP_OrderWithRetencionCodeInJDE_AR</name>
            <type>Task</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Opportunity.CD_order_status_country__c</field>
            <operation>equals</operation>
            <value>5</value>
        </criteriaItems>
        <description>If an order is retained this workflow creates a task.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Opportunity.Existe_item_em_backorder_pais__c</field>
            <operation>equals</operation>
            <value>5</value>
        </criteriaItems>
        ...
        <workflowTimeTriggers>
            ...
            <offsetFromField>Opportunity.Data_ultima_alteracao_dos_itens__c</offsetFromField>
            <timeLength>10</timeLength>
            <workflowTimeTriggerUnit>Days</workflowTimeTriggerUnit>
        </workflowTimeTriggers>
    </rules>
    ...
    <rules>
        ...
        <formula>AND(Account.Business_Unit_AR__r.CodDefUsuario__c=&apos;09&apos;,  Account.Business_Unit_AR__r.RecordType.DeveloperName = &apos;Standard_UY&apos;,  OR( Account.RecordType.DeveloperName = &apos;ACC_2_OffTrade_URU&apos;,  Account.RecordType.DeveloperName = &apos;ACC_4_OnTrade_URU&apos;),  BEGINS(TEXT(Type), &apos;SO&apos;))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <formula>AND(Account.Business_Unit_AR__r.CodDefUsuario__c=&apos;10&apos;, Account.Business_Unit_AR__r.RecordType.DeveloperName = &apos;Standard_UY&apos;, OR( Account.RecordType.DeveloperName = &apos;ACC_2_OffTrade_URU&apos;, Account.RecordType.DeveloperName = &apos;ACC_4_OnTrade_URU&apos;),  BEGINS(TEXT(Type), &apos;SF&apos;))</formula>
        <triggerType>onCreateOnly</triggerType>
    </rules>
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Opportunity.Existe_item_em_backorder__c</field>
            <operation>equals</operation>
            <value>1</value>
        </criteriaItems>
        <criteriaItems>
