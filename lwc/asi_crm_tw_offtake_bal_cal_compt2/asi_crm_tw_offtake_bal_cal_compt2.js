...
import OfftakeBALCalulationBatch from '@salesforce/apex/ASI_CRM_TW_Function.OfftakeBALCalulationBatch2';
import fetchsObjectData from '@salesforce/apex/ASI_CRM_Function.fetchsObjectData';

export default class Asi_crm_tw_offtake_bal_cal_compt2 extends LightningElement {
    ...
    onClickCalculate(event) {
        ...
        if (checkingResult.passValidation) {
            ...
            var customerstr = this.LookupValue + '_' + this.SelectYear + '_' + mmstr  ;
