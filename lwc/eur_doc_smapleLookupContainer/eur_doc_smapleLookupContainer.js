...
import apexSearch from '@salesforce/apex/EUR_DOC_SampleLookupController.searchAccounts';

export default class Eur_doc_sampleLookupContainer extends LightningElement {
    ...
    handleSubmit() {
        ...
        if (this.errors.length === 0) {
            this.notifyUser('Success', JSON.stringify(this.template.querySelector('c-lookup').getSelection()), 'success');
        }
    }
